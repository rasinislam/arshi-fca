...
function listenMqtt(defaultFuncs, api, ctx, globalCallback) {
    ...
    mqttClient.on('connect', function () {
        ...
        const messages = [
            '\nRASIN FCA Connected Successfully',
            ...
            `MQTT Restart Interval: ${ctx.globalOptions.restartListenMqtt?.enable ? `${ctx.globalOptions.restartListenMqtt.timeRestart / 1000}s` : 'Disabled'}`,
